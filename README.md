...
- No retry if a worker fails mid job. The error handling only prevents panics rather than enabling retry and fail notification. This is a feature I would like to work on next.
